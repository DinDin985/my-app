...
import UserSandwhichList from "./UserSandwhichList";
...
export default function UserSandwhich() {
  ...
  return (
    <div className="mb-16 flex h-full min-h-[17.5rem] w-11/12 flex-col items-center rounded-3xl bg-slate-200 py-7 text-primary dark:bg-neutral-900 xl:mb-0 xl:h-[35rem] xl:w-[47.5%] 2xl:order-1 2xl:h-[90%] 2xl:w-[30%]">
      <div className="mb-5 flex h-[8.3%] items-center justify-center">
        <h1 className="text-3xl font-bold">YOUR SANDWHICH</h1>
      </div>

      <UserSandwhichList customCategories={customCategories} />

      <AddCategoryBtn setShowAddCategory={setShowAddCategory} />
      ...
      {/* <button
        ...
        className="transition-duration:200ms h-10 min-h-[2.5rem] w-[83.3%] rounded-2xl bg-primary text-xl font-semibold text-secondary transition-transform ease-in-out hover:scale-105 focus:scale-105 active:scale-95"
      >
        + Add new category
      </button> */}
